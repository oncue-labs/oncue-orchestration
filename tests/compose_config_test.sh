...
ENV_FILE="${ROOT_DIR}/.env.template"
...
assert_contains "ONCUE_AUTH_X_CLIENT_SECRET: replace-with-a-local-x-client-secret"
assert_contains "REFRESH_TOKEN_TTL: 720h"
assert_contains "X_REDIRECT_URI: com.oncue.oncuemobile://oauth/x/callback"
assert_contains "VOICE_INTERNAL_SERVICE_TOKEN: replace-with-local-voice-token"
...
assert_contains "ONCUE_VOICE_TURN_URLS: turn:192.168.200.109:3478?transport=udp,turn:192.168.200.109:3478?transport=tcp"
assert_contains "network_mode: host"
